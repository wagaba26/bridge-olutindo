...
export const metadata = {
  title: "Language School Partners | Bridge Olutindo",
  description: "Verified Japanese language school partners for study in Japan.",
};

const focusAreas = [
  "Japanese levels supported and placement tests",
  "Intensity, class hours, and progression",
  "Student support and guidance systems",
  "Verified contact channels",
];

const categories = ["Academic Japanese", "Intensive immersion", "Flexible schedules"];
    ...
    <div className="min-h-screen bg-[linear-gradient(180deg,#fffcf7_0%,#f7f9fc_42%,#fffcf7_100%)]">
        ...
        <div className="container mx-auto grid gap-8 px-4 md:grid-cols-[minmax(0,1fr)_minmax(0,0.9fr)] md:items-center">
          <FadeIn>
            <div className="space-y-4 md:space-y-5">
              ...
              <h1 className="max-w-2xl text-balance">Language school partners</h1>
              <p className="max-w-2xl text-slate-600">
                Language institutes will appear here once we verify program fit and support quality.
              </p>
              <div className="flex flex-col gap-3 sm:flex-row">
                ...
                <Button asChild variant="outline" className="h-11 rounded-xl px-5">
                  <Link href="/contact">Nominate a language school</Link>
                </Button>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="py-10 md:py-12">
        <div className="container mx-auto space-y-6 px-4">
          <FadeIn>
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-600">Study focus</p>
